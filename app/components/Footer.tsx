      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/" className="hover:text-sky-400 transition">Calculator</Link>
              </li>
              <li>
                <Link href="/over-mij" className="hover:text-sky-400 transition">Over de maker</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              {popularCities.slice(0, 5).map((city) => (
                <li key={city.slug}>
                  <Link href={`/${city.slug}`} className="hover:text-sky-400 transition">
                    Droogweer {city.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              {tools.slice(0, 5).map((tool) => (
                <li key={tool.name}>
                  <a href={tool.url} target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 transition">
                    {tool.name}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            ...
            <a href="https://hazier.be" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:text-sky-300">
              Hazier
            </a>
          </p>
